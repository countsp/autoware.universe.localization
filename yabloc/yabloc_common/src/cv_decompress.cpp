...
#include <iostream>
//解压缩ROS中的压缩图像消息，并将其转换为OpenCV的cv::Mat格式，以便进行进一步的图像处理

namespace yabloc::common
{
//解压缩一个ROS中的压缩图像消息，并转换成cv::Mat格式。
//解压缩并可能从Bayer模式转换成BGR颜色空间的图像。
...
//将ROS的压缩图像消息解压缩，并转换为另一个ROS图像消息格式，允许指定输出图像的编码。
