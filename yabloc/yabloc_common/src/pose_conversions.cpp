...
{
//将Eigen::Affine3f对象转换为ROS的geometry_msgs::msg::Pose消息。
...
//将ROS的geometry_msgs::msg::Pose消息转换为Eigen::Affine3f对象。
...
//将ROS的geometry_msgs::msg::Pose消息转换为Sophus::SE3f对象。
...
//将Sophus::SE3f对象转换为ROS的geometry_msgs::msg::Pose消息。
