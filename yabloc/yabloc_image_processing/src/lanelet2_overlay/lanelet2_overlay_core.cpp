...
// 将 Lanelet2叠加到图像上
//通过订阅图像、车辆姿态、相机信息和 Lanelet2 数据，能够实时将道路信息叠加到接收到的图像上，从而为自动驾驶系统提供更丰富的环境感知信息。
...
//处理接收到的图像消息，通过叠加 Lanelet2 数据到图像上来增强图像信息。
...
//在给定图像上叠加 Lanelet2 数据，包括道路标记和标志板。
